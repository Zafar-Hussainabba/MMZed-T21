package code.src.BaseAttributes.system.Default;

import code.src.BaseAttributes.system.Default.interfaces.IDefaultAttributes;

import java.util.HashMap;

public class DefaultSystemAttributes implements IDefaultAttributes {
