package code.src.BaseAttributes.system.Environment;

import code.src.BaseAttributes.system.Environment.interfaces.IEnvironmentAttributes;

import java.util.HashMap;

public class EnvironmentSystemAttributes implements IEnvironmentAttributes {
