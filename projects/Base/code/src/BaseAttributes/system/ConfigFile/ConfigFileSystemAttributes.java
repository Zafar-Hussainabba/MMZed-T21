package code.src.BaseAttributes.system.ConfigFile;

import code.src.BaseAttributes.system.ConfigFile.interfaces.IConfigFile;

import java.util.HashMap;

public class ConfigFileSystemAttributes implements IConfigFile {
