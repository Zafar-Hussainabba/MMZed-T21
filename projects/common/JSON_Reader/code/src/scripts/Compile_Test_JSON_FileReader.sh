...
JAVA_CLASS_FILE1_NAME=Test_JSON_FileReader.java
JAVA_CLASS_FILE2_NAME=JSON_FileReader.java
JAVA_CLASS_FILE1=$JAVA_CLASS_FILE_DIR/$JAVA_CLASS_FILE1_NAME
JAVA_CLASS_FILE2=$JAVA_CLASS_FILE_DIR/$JAVA_CLASS_FILE2_NAME
...
#specifying path to store compiled java classes
...
$JAVAC -d "$JAVA_COMPILED_CLASS_DIR"  -classpath $LOG4J_JAR_FILE:$JSON_PARSER_JAR_FILE $JAVA_CLASS_FILE2 $JAVA_CLASS_FILE1
